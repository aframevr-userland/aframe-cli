...
For example:
  ...
  ${commandStr} ${chalk.green('my-aframe-scene')}
...
A-Frame scene will be initialized. Pass a template name or URL like so:
  ...
  ${commandStr} ${chalk.underline('default')} ${chalk.green('my-aframe-scene')}
  ${commandStr} ${chalk.underline('aframe-default-template')} ${chalk.green('my-aframe-scene')}
  ${commandStr} ${chalk.underline('https://github.com/aframevr/aframe-default-template')} ${chalk.green('my-aframe-scene')}
  ${commandStr} ${chalk.underline('aframevr/aframe-default-template')} ${chalk.green('my-aframe-scene')}
