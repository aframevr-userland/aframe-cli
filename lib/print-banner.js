...
A-Frame scene will be initialized. Pass a template name or URL like so:
  ...
  ${commandStr} ${chalk.underline('default')} ${chalk.green('my-project-directory')}
  ${commandStr} ${chalk.underline('aframe-default-template')} ${chalk.green('my-project-directory')}
  ${commandStr} ${chalk.underline('https://github.com/aframevr/aframe-default-template')} ${chalk.green('my-project-directory')}
  ${commandStr} ${chalk.underline('aframevr/aframe-default-template')} ${chalk.green('my-project-directory')}
