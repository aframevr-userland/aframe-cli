...
A-Frame scene will be initialized. Pass a template name or URL like so:
  ...
  ${commandStr} ${chalk.green('my-project-directory')} --template ${chalk.underline('https://github.com/aframevr/aframe-default-template')}
  ${commandStr} ${chalk.green('my-project-directory')} --template ${chalk.underline('aframevr/aframe-default-template')}
